...
function AboutUs() {
  return (
    ...
    <div className='h-[500px] w-full bg-no-repeat bg-contain bg-[url("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRw0S5tnulkEUedZ19cSSk9bhsgEC4usIzd3Q&usqp=CAU")]'></div>
        </div>
  )
}
